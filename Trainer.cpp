...
namespace CNetworks {
Trainer::Trainer(DataLoader &&loader, LossFunction &&loss,
...
Network Trainer::Train(Network &&net) {
...
void Trainer::TrainOneEpoch(std::vector<Layer> &layers) {
...
Trainer::Metrics Trainer::ComputeMetrics(const Network &net) const {
...
void Trainer::PrintMetrics(const Metrics &metrics) const {
